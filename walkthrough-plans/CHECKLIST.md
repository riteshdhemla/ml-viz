...
**249 notebooks.** `[ ]` todo · `[~]` plan written · `[x]` walkthrough done.

Status is also the source of truth for progress. Edit the boxes as you go.
...
- [x] `neural-networks/05-batchnorm-and-dropout` — 19,453 chars
- [x] `neural-networks/06-weight-initialization` — 5,040 chars
...
- [x] `cnns/02-pooling-and-architectures` — 18,239 chars
- [x] `cnns/03-cnn-visualization-and-attacks` — 10,322 chars
- [x] `cnns/04-transfer-learning` — 10,773 chars
- [x] `cnns/05-modern-architectures` — 18,803 chars
...
- [x] `transformers/04-modern-attention` — 20,439 chars
- [x] `transformers/05-foundation-models-and-scaling` — 7,957 chars
- [x] `transformers/06-mixture-of-experts` — 11,405 chars
...
- [x] `generative-models/04-generative-adversarial-networks` — 20,825 chars
- [x] `generative-models/05-diffusion-models` — 11,441 chars
- [x] `generative-models/06-vit-and-modern-genai` — 20,261 chars
...
- [ ] `ml-in-practice/14-anomaly-detection` — 5,237 chars
- [ ] `ml-in-practice/15-privacy-and-federated-learning` — 4,927 chars
...
- [ ] `ml-in-practice/20-fraud-detection-at-scale` — 6,923 chars
- [ ] `ml-in-practice/21-content-moderation` — 5,056 chars

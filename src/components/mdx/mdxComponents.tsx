...
// Visualization components (lazy-loaded per lesson)
// import { NeuralNetworkViz } from "@/components/visualizations/NeuralNetwork";
...
export const mdxComponents: MDXComponents = {
  ...
  // Interactive components available in MDX
  Callout,
  Exercise,

  // Placeholder for visualization components — uncomment as you build them:
  // NeuralNetworkViz,
  // GradientDescentViz,
  // PerceptronViz,
  // AttentionViz,

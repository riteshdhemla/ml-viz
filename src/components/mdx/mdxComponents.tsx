...
export const mdxComponents: MDXComponents = {
  ...
  AnchorMatchingViz: viz("AnchorMatchingViz"),
  AnomalyThresholdViz: viz("AnomalyThresholdViz"),
  ...
  BottleneckViz: viz("BottleneckViz"),
  ...
  ConditionalAreaViz: viz("ConditionalAreaViz"),
  CondorcetViz: viz("CondorcetViz"),
  ConstrainedOptViz: viz("ConstrainedOptViz"),
  ...
  DoubleDescentViz: viz("DoubleDescentViz"),
  ...
  ExperienceReplayViz: viz("ExperienceReplayViz"),
  FGSMViz: viz("FGSMViz"),
  ...
  OverSmoothingViz: viz("OverSmoothingViz"),

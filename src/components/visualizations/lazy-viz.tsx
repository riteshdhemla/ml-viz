...
const VIZ: Record<string, ComponentType<VizProps>> = {
  ...
  DoubleDescentViz: dynamic(() => import("@/components/visualizations/DoubleDescent/DoubleDescentViz").then((m) => m.DoubleDescentViz)) as ComponentType<VizProps>,
  ...
  SGDNoiseViz: dynamic(() => import("@/components/visualizations/SGDNoise/SGDNoiseViz").then((m) => m.SGDNoiseViz)) as ComponentType<VizProps>,
